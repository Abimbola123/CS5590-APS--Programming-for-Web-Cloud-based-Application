        ...
        $scope.getVenues = function () {
            ...
            if (placeEntered != null && placeEntered != "" && searchQuery != null && searchQuery != "") {
                ...
                var handler = $http.get("https://api.foursquare.com/v2/venues/search" +
                    "?client_id=HQYZYDQSYUOACCU0KRQAYD5RVWKO2XZCWT5RPZQYVRWBIT5V" +
                    "&client_secret=JGWVTW002T2D3R5KS5VEBUBWUFV4I5K3DHTSFG35VP1GQXV4" +
                    "&v=20160215&limit=5" +
                    "&near=" + placeEntered +
                    "&query=" + searchQuery);
        ...
        $scope.getReviews = function (venueSelected) {
            if (venueSelected != null) {
                ...
                var handler = $http.get("https://api.foursquare.com/v2/venues/" + venueSelected.id + "/tips" +
                    "?sort=recent" +
                    "&client_id=HQYZYDQSYUOACCU0KRQAYD5RVWKO2XZCWT5RPZQYVRWBIT5V" +
                    "&client_secret=JGWVTW002T2D3R5KS5VEBUBWUFV4I5K3DHTSFG35VP1GQXV4=20160215" +
                    "&limit=5");
                handler.success(function (result) {
                    if (result != null && result.response != null && result.response.tips != null &&
                        ...
                        var callback = $http.get("http://gateway-a.watsonplatform.net/calls/text/TextGetTextSentiment" +
                            "?apikey=AIzaSyCY82gvjVwLIYx4YSBDMklHhs0776FM4k8\n" +
                            "\n" +
                            "content_copy\n" +
                            "info" +
